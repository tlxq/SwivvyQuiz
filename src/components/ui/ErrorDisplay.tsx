 ...
 */
export const ErrorDisplay = React.memo(({ message, onBack }: ErrorDisplayProps) => {
  return (
    <View style={theme.styles.centerScreen}>
      <Text style={[theme.typography.h3, styles.errorText]}>Oops!</Text>
      <Text style={[theme.typography.body, styles.messageText]}>{message}</Text>
      <Button label="Go Back" onPress={onBack} variant="primary" style={styles.button} />
    </View>
  );
});
